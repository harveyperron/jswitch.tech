...
$paypalConfig = [
    'email' => 'iosypenko9@gmail.com',
  	'return_url' => 'https://estateelegance.com/confirmation.php?order_id='.$order_id.'&payment_method=paypal',
    'cancel_url' => 'https://estateelegance.com/index.php/payment_canceled/',
