...
<body>
<center>
<div class="topbar fha w">

	<a href="https://jswitch.tech"  class="fhc">
	<div class="fvc">
	...
	<div class="fhc w navbar">
        ...
        <div rel="smartphone" class="nav-item">Téléphones</div>
        <div rel="laptop" class="nav-item">Laptops</div>
        <div rel="computer" class="nav-item">Ordinateurs</div>
        <div rel="race drone" class="nav-item">Drones</div>
