...
<div class="fvc">
	...
	<div class="fhc w navbar">
        <div class="nav-item">Télévisions</div>
        <div class="nav-item">Téléphones</div>
        <div class="nav-item">Laptops</div>
        <div class="nav-item">Ordinateurs</div>
        <div class="nav-item">Drones</div>
        <div class="nav-item">Wearables</div>
        <div class="nav-item">Accessories</div>
        <div class="nav-item">Ebikes</div>
    </div>
	</div>
  ...
  if (Array.isArray(products)) {
    products.forEach(product => {
      const productHtml = template
        ...
        .replace(/\{price\}/g, 'CA$ ' + Math.round(product.sellingStatus[0].convertedCurrentPrice[0].__value__*1.39*100)/100);
