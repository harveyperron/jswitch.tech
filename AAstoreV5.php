...
Les suggestions fonctionnent et les produits sont à jour en rafraichissant la page. Mais le moteur de recherche reste encore défaillant. Je devrai encore continuer de fouetter chatGPT pour me faire un meilleur code :P
</div>
</div>
	...
	<div class=card>
        ...
        <?php
        $categories = ["Laptop", "PC", "Smartphone", "Smart TV", "e-bike","smart home"];
